...
const Rag = () => {
    ...
    return (
        <div className="flex justify-center items-center h-screen p-2 bg-black">
            <div className="flex flex-col justify-between bg-white h-full w-full rounded-3xl">
                ...
                <div className="flex shrink flex-col items-center mx-4 raqQueryContainer">
                    <p className="overflow-y-scroll h-4/5">{citation}</p>
                    <p className="mt-4">{source}</p>
                    <p className="mt-4">{location}</p>
                </div>
                <div className="bg-grey3 rounded-b-3xl h-12 "></div>
            </div>
        </div>
    );
};
